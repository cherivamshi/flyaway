...
public class Home_page_test {
	...
	public void login_page() throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "/home/tonyanudeepgmai/Downloads/chromedriver");
...
//		
//		Thread.sleep(3000);
//		Registration_page.email.sendKeys("vamshi@xyz");
//		
//		Thread.sleep(3000);
...
//		
//		Thread.sleep(3000);
//		Registration_page.name.sendKeys("vamshi");
//		
//		Thread.sleep(3000);
//		Registration_page.address.sendKeys("warangal, telangana");
//		
//		Thread.sleep(3000);
//		Registration_page.city.sendKeys("telangana");
...
//		Register_confirm.login.click();
		...
		Thread.sleep(3000);
		Login_page.Loginemail.sendKeys("vamshi@xyz");
